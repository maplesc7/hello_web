...
- `timer3/`
  - 30分固定の視覚的なカウントダウンタイマー
  - 円形ゲージと横ゲージで残り時間を表示し、開始・一時停止・再開・リセットに対応
  - タイマー状態をブラウザに保存し、ページ再読み込み後も復元
  - iPhone Safariの縦画面とセーフエリアに最適化した単体HTML
  - ▶ 公開ページ: https://hello-web-er0.pages.dev/timer3/
